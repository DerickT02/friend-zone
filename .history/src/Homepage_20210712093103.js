    ...
    return (
        <div>
            ...
            {posts.map((post) => {
                return (
                    <div className = 'post'>
                        <div className = 'deleteButton'><button style = {{"background-color":"red", 'color':'white', "border": "none", 'cursor': 'pointer'}} onClick = {() => removePostfromHomepage(post.key)}>X</button></div>
                            <div>
